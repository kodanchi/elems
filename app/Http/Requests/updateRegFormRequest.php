...
class updateRegFormRequest extends Request
{
    /**
    ...
    public function authorize()
    {
        ...
        //dd($formid);
        return RegForm::where('id','!=',$formid);*/
    ...
    public function rules()
    {
        ...
        return [
            'NID' => 'required|unique:reg_forms,NID,'.$formid.'|numeric|min:1000000',
            ...
            //'email'=> array('required','unique:reg_forms','email,'.$formid,'regex:'.$email_regex),
            'email'=> 'required|email|unique:reg_forms,email,'.$formid,
