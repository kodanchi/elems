        ...
        <div class="row ">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">{{trans('LDprogram.Courses')}}</div>
                    <div class="panel-body">
                     ...
                     <a type="button" class="btn-lg btn-sq-lg" aria-label="Left Align" onclick="myFunction()"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true" style="font-size: xx-large; margin: 10px; margin-bottom: 30px"></span></a>
                         ...
                         <div class="col-md-12" >
                             <div id="myDIV">
                                    {!! Form::open(['url' => '/ld/test/add/courses', 'method' => 'post']) !!}

                               <div class="col-md-6" >
                                        {!! Form::label('', trans('LDprogram.Course_id')) !!}
                                 ...
                                 <div class="col-md-6" >
                                     {!! Form::label('', trans('LDprogram.Program_inst_id')) !!}
                                     <span class="glyphicon glyphicon-asterisk" aria-hidden="true" style="font-size: xx-small;color: #b10000"></span>

                                     <select name="program_inst_id" class="form-control" >
                                         <option value="" style="direction: ltr"></option>
                                         @foreach($Program_instances as $A)
                                 ...
                                 <div class="col-md-6" >
                                  ...
                                  <br>
                                    ...
                                    <br>
                             <div class="col-md-12">
                                 <h3>{{trans('LDprogram.Courses_list')}}</h3>
                                 <br>
                                 ...
                                 <table class="table order-table table-responsive table-hover  results">
                                     ...
                                     <th>{{trans('LDprogram.Course_id')}}</th>
                                     <th>{{trans('LDprogram.sDate')}}</th>
                                     <th>{{trans('LDprogram.eDate')}}</th>
                                     <th>{{trans('LDprogram.Program_inst_id')}}</th>
                                     <th></th>
                                     <th></th>
                                     </thead>
                                     <tbody>
                                     @foreach( $courses as  $course)
                                         <tr>
                                             ...
                                             <td>{{$course->sDate}}</td>
                                             <td>{{$course->eDate}}</td>
                                             <td>{{$course->program_instance_name}}</td>
                                             <td>
                                                 {!! Form::open(['url' => '/ld/test/delete/courses', 'method' => 'post']) !!}
                                                 {!! Form::hidden('id', $course->id) !!}
                                                 {!! Form::hidden('locale', $locale) !!}
                                                 {{--{{ Form::button('<span class="glyphicon glyphicon-remove "></span>', array('class'=>'btn btn-link', 'type'=>'submit' )) }}--}}
                                                 <button type="button" class="btn-link" data-toggle="modal" data-target="#exampleModal" data-whatever="{{$course->id}}"><span class="glyphicon glyphicon-remove-circle  btn-lg" style="color: rgba(203, 0, 14, 0.92)"></span></button>
                                                 {!! Form::close() !!}
                                             </td>
                                             <td></td>
                                         </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(array('url' => '/ld/test/delete/courses/', 'method' => 'post')) }}
                    {!! Form::hidden('locale', $locale) !!}
                    {!! Form::hidden('user_id', $systemUserID) !!}
