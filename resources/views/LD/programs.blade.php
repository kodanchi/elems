        ...
        <div class="row ">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">{{trans('LDprogram.program')}}</div>
...
--}}
                            ...
                            <div class="col-md-12" >
                                <div id="myDIV">
                                    {!! Form::open(['url' => '/ld/test/add/program', 'method' => 'post']) !!}
                                ...
                                <div class="col-md-12">
                                    <h3>{{trans('LDprogram.programsList')}}</h3>
                                    <br>
                                        ...
                                        <tbody>
                                            @foreach( $Programs as  $Program)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {!! Form::open(['url' => '/ld/test/delete/program', 'method' => 'post']) !!}
                                                            {!! Form::hidden('id', $Program->id) !!}
                                                            {!! Form::hidden('locale', $locale) !!}
                                                            {{--{{ Form::button('<span class="glyphicon glyphicon-remove "></span>', array('class'=>'btn btn-link', 'type'=>'submit' )) }}--}}
                                                            <button type="button" class="btn-link" data-toggle="modal" data-target="#exampleModal" data-whatever="{{$Program->id}}"><span class="glyphicon glyphicon-remove-circle  btn-lg" style="color: rgba(203, 0, 14, 0.92)"></span></button>
                                                        {!! Form::close() !!}
                                                    </td>
                                                    <td></td>
                                                </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(array('url' => '/ld/test/delete/program/', 'method' => 'post')) }}
                    {!! Form::hidden('locale', $locale) !!}
                    {!! Form::hidden('user_id', $systemUserID) !!}
