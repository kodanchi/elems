                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body ">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                {!! Form::open(['url' => '/reservation/validate', 'method' => 'post','class'=>'newsletter-form']) !!}
                                    <!--- email Field --->
                                    ...
                                    <p></p>
                                    <a href="{{url('/reservation/new')}}" type="button" class="button form-control">إدخال ايميل  مختلف</a>
                                {!! Form::close() !!}
