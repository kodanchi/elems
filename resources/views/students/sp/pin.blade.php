                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body ">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                {!! Form::open(['url' => '/students/sp/validate', 'method' => 'post','class'=>'newsletter-form']) !!}

                                    <!--- email Field --->
                                    <div class="form-group">
                                        {!! Form::label('email', trans('sp.email').':') !!}
                                    ...
                                    <p></p>
                                    <a href="{{url('/students/sp')}}" type="button" class="button form-control">إدخال رقم اكاديمي مختلف</a>
                                {!! Form::close() !!}
