...
--}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="form-group">
                                        {!! Form::label('attachment1_L', 'إرفاق الشهادة الثانوية') !!}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="form-group">
                                        {!! Form::label('attachment2_L','إرفاق الهوية الوطنية/الإقامة ') !!}
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        {!! Form::label('attachment3_L','إرفاق جواز السفر او الرخصة ') !!}
