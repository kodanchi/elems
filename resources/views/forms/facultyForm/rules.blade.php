                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body ">
                        <div class="row">
                            ...
                            <hr>
                            <h4 class="col-md-12">{{trans('facultyForm.intro')}}</h4>
                            <div class="col-md-12">
                                ...
                                @endforeach--}}
                                <a href="{{LaravelLocalization::getLocalizedURL(null,'/form/facultyform/new')}}" class="btn btn-primary btn-lg" role="button"><span class="glyphicon glyphicon-plus"></span> <br/>{{trans('facultyForm.submitNow')}}</a>
