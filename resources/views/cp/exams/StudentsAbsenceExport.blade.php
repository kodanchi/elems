...
@section('content')
            ...
            <div class="col-md-12 text-center">
                ...
                <table class="tableStyle"  style="border:solid;border-color: black;  width:100%" border="1">
                    ...
                    <tr class="tableStyle" >
                        ...
                        <th  style="text-align: center ; font-size: large">المركز</th>
                        <th  style="text-align: center ; font-size: large">المبنى</th>
                        <th  style="text-align: center ; font-size: large">القاعة</th>
                    ...
                    @foreach($forms as $form)
                        <tr class="tableStyle" >
                            ...
                            <td>{{$form->date}}</td>
                            @if(Auth::User()->getRole() == 'admin')
                                {{--<td><a href="{{url('/cp/exams/StudentsAbsenceEdit/'.$form->id)}}">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">إلغاء غياب الطالب</h4>
                ...
                <div class="modal-body">
                    <form id="form-id" method="get">
                        <div class="form-group">
                            ...
                            <h5 style="color: red">إن إلغاء غياب الطالب عملية لا يمكن الرجوع عنها بعد تنفيذها</h5>
    ...
    <script >
        ...
        function foo()
        {
            ...
            //document.getElementById('form-id').action = "approve/reject/"+recipient+"/"+document.getElementById('reason').value;
            document.getElementById('form-id').action = "/cp/exams/StudentsAbsenceExport/export/delete/"+recipient+"/"+document.getElementById('center_id').value+"/"+document.getElementById('date').value;
            return true;
        }
