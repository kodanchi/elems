                                ...
                                <div class="row">
                                    <div class="col col-md-12">
                                        ...
                                        <table class="table table-stripped table-hover" border="1">
                                            ...
                                            <th class="text-center" style="background-color: #2b669a; color: white">الساعات المسجلة</th>
                                            <th class="text-center" style="background-color: #2b669a; color: white">المستحق (ريال)</th>
                                            <th class="text-center" style="background-color: #2b669a; color: white">المدفوع (ريال)</th>
                                            </thead>
                                            <tbody>
                                            @foreach($terms as $term)
                                                <tr class="text-center">
                                                    ...
                                                    <td style="text-align:center;   vertical-align: middle">
                                                        @foreach($CHs as $CH)
                                                            @if($CH->tid===$term->term_id)
                                                                {{--{{$course->course_id}} --}}{{--<span> | </span>--}}{{-- {{$course->subject}}--}}
                                                                <?php $termTotal+=$CH->CH*150*$students->discount; ?>
                                                                {{--<br>--}}
                                                                @if(is_int($CH->CH))
                                                                    لا توجد ساعات مسجلة
                                                                @else
