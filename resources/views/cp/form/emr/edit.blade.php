...
@section('content')
            ...
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::model($regForm, ['url' => url('/cp/form/emr/'.$regForm->id.'/update'), 'method' => 'post', 'files' => true,'id'=>'newRegForm','class' => 'newsletter-form']) !!}
                            ...
                            <div id="div_center" class="col col-md-6">
                                <div id="center_div">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('center_first', [] , null , ['class' => 'form-control','id'=>'center_first']) !!}
                                    </div>
                                    <!--- Second Center Field --->
                                    <div class="form-group">
                                        {!! Form::label('center_second', trans('regform.center_second').':') !!}
                                        {!! Form::select('center_second', [] , null , ['class' => 'form-control','id'=>'center_second']) !!}
                                    </div>
                                </div>
                                <div id="div_center_select">
                                    {!! Form::select('center_first', $centers , null , ['class' => 'form-control','id'=>'center_1']) !!}
                                    {!! Form::select('center_second', $centers , null , ['class' => 'form-control','id'=>'center_2']) !!}
                        ...
                        <div class="row">
                                {!! Form::submit(trans('regform.update'), ['class' => ' col-md-3']) !!}
                                <a href="{{url('/cp/form/emr/')}}" class="button">{{trans('regform.cancel')}}</a>
    ...
    <script type="text/javascript">
        ...
        function setCenters() {
            $('#center_first').val( $('#center_1').val());
            $('#center_second').val( $('#center_2').val());
        }
