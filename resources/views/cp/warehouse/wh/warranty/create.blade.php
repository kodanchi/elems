        ...
        <div class="row ">
            <div class="col-md-7 col-md-offset-3">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">إضافة ضمان جديد </div>
                    ...
                    <div class="panel-body newsletter-form ">
                        ...
                        {!! Form::open(['url' => url('cp/warehouse/warranty'), 'method' => 'post']) !!}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <a href="{{url('cp/warehouse/warranty')}}" class="form-control button">رجوع</a>
                            </div>
